  ...
  <Modal :value="value" @input="close">
    <div class="delete">
      <div class="delete__header">
        <div class="header__title">Delete Category</div>
    ...
    methods: {
      ...
      async deleteCategory() {
        try {
          ...
          await CategoryGateway.DeleteOneById({
            categoryId: this.category._id,
          });

          const filteredCategories = this.categories.filter(
            ({ _id }) => _id !== this.category._id,
          );

          store.commit.categories.setCategories(filteredCategories);
