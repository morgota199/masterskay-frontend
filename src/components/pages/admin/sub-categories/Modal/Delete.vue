  ...
  <Modal :value="value" @input="close">
    <div class="delete">
      <div class="delete__header">
        <div class="header__title">Delete Sub Category</div>
      ...
      <div class="setup">
        <span> Are you sure you want to delete the sub category? </span>
      </div>
      ...
      <div class="action">
        ...
        <Button class="action__button" type="danger" @click="deleteCategory">
          Delete
        </Button>
      </div>
    </div>
    ...
    methods: {
      ...
      async deleteCategory() {
        try {
          ...
          await SubCategoryGateway.DeleteOneById({
            subCategoryId: this.subCategory._id,
          });

          const filteredSubCategories = this.subCategories.filter(
            ({ _id }) => _id !== this.subCategory._id,
          );

          store.commit.categories.setSubCategories(filteredSubCategories);
